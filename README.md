...
| Tab      | 图标 | 页面                                                              | 核心功能                                                                                                                 |
| -------- | ---- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| **首页** | 🏠   | [home_page.dart](la-le-me-app/lib/screens/home_page.dart)         | 查看今日出库次数、5日趋势图(大号/小号/总计三线)、历史总次数(⭐次叔)、智能健康状态(❤️)、快速记录(大号/小号)、每日健康提示 |
...
| 版本   | 日期       | 状态                                                                                                        |
| ------ | ---------- | ----------------------------------------------------------------------------------------------------------- |
| v1.0.5 | 2026-05-13 | ✅ 首页小号趋势曲线、历史总次数统计、智能健康状态、💩日历标记 [GitHub](https://github.com/kaptree/WcRemark) |
